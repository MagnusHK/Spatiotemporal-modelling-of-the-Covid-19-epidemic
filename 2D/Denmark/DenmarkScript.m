...
I(446, 42) = 0.2040;     %Copenhagen
I(444, 35) = 0.0291;     %Frederiksberg
I(460, 97) = 0.0291;     %Roskilde
I(332, 322) = 0.0291;    %Aarhus
I(446, 209) = 0.0291;    %kalundborg
I(481, 372) = 0.0291;    %Middelfart
...
%%
Video = VideoWriter('DenmarkSimulation_delta');
Video.FrameRate = 30;
open(Video)
...
[xs, ys] = meshgrid(0:0.6632:(n-1)*0.6632, 0:0.6632:(m-1)*0.6632);
...
title('SIR model with diffusion on Denmark', ...
        Interpreter='latex')
